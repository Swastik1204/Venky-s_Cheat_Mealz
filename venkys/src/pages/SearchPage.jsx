        ...
        cats.forEach(cat => {
          if (Array.isArray(cat.items)) {
            cat.items.forEach((it, idx) => {
              ...
              const effectiveRate = Number.isFinite(rateNumber) && rateNumber >= 0 ? Math.round(rateNumber * 100) / 100 : Math.round(rawPrice * 100) / 100
              const mrpRaw = typeof it.mrp === 'number' ? it.mrp : Number(it.mrp)
              const mrpNumber = Number.isFinite(mrpRaw) && mrpRaw > 0 ? Math.round(mrpRaw * 100) / 100 : null
              ...
              all.push({
                ...
                rating: typeof it.rating === 'number' ? it.rating : Number(it.rating),
